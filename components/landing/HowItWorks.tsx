...
const steps = [
  ...
  },
  {
    ...
    description:
      "Don't know where to start? Nine curated templates give you 10 pre-built alerts in one click: momentum breakouts, screened mid-cap radar, 200-day turnarounds, sector rotation, and more.",
    icon: Sparkles,
  ...
  },
  {
    ...
    icon: BrainCircuit,
    example: "\"AAPL broke $230 on 1.6x volume, 18 days before earnings. Traders watch for breakout continuation or a pre-earnings fade.\"",
  },
];
    ...
    <section id="how" className="border-t border-lp-border/70 bg-white py-20">
      <div className="mx-auto w-full max-w-[1440px] px-5 sm:px-8 lg:px-12">
        <div className="max-w-2xl space-y-3">
          ...
          <h2 className="font-serif text-3xl text-lp-navy md:text-4xl">From signup to first alert in 60 seconds</h2>
        </div>
