      ...
      <div className="flex flex-wrap items-end justify-between gap-4">
        <div>
          ...
          <p className="mt-3 max-w-2xl text-base text-lp-navy/75">
            Every weekday at 4 AM Pacific the app writes two articles about stocks in the news, copies the ads that ran in yesterday&apos;s Smart Investor issues, and creates two drafts in Beehiiv. Nothing is sent until you click Send there.
          </p>
        </div>
